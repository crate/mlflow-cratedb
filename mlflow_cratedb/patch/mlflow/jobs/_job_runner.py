# This is a copy of `mlflow.server.jobs._job_runner`. Because it is located
# within the `mlflow_cratedb` package, the code will be amalgamated to use
# CrateDB as a storage backend.
# TODO: It is not too easy to reuse the code from `mlflow.server.jobs._job_runner`,
#       because it is stored within the `__main__` section. Are there still ways
#       to reuse it here?
"""
